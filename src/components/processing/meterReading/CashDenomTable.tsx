            ...
            notes.map((data: any, idx: number) => (
              <tr key={data.Id}>
                ...
                <td>
                  <TextFieldInput
                    placeholder={
                      text.placeholders.meterReading.transactionCash.denominator
                    }
                    ...
                    disabled={
                      ...
                      (amountTobePaidInCash < data.Note_Value ||
                        amountTobePaidInCash - cashTransactionGrandTotal < 0)
                    }
                    size={"small"}
                    fullwidthState
                  />
